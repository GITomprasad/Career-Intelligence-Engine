...
def render_goal_view(components: dict):
    """
    Renders the unified Goal Mode tab.
    """
    ...
    <div style="margin-bottom: 20px;">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 12px;">
            ...
            <div style="text-align: right;">
                <div style="font-size: 0.82rem; font-weight: 600; text-transform: uppercase; color: var(--text-secondary);">Role Readiness</div>
    ...
    st.markdown('<h4 style="margin-top: 0; margin-bottom: 14px; font-weight: 700;">1. Skill Gap Decomposition</h4>', unsafe_allow_html=True)

    c_str, c_imp, c_mis = st.columns(3)

    with c_str:
        st.markdown(f"""
        <div style="font-size: 0.9rem; font-weight: 700; color: var(--color-success-text); margin-bottom: 8px;">
    ...
    with c_imp:
        st.markdown(f"""
        <div style="font-size: 0.9rem; font-weight: 700; color: var(--color-warning-text); margin-bottom: 8px;">
    ...
    with c_mis:
        st.markdown(f"""
        <div style="font-size: 0.9rem; font-weight: 700; color: var(--color-danger-text); margin-bottom: 8px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
        <h4 style="margin: 0; font-weight: 700;">2. Phased Actionable Learning Pathway</h4>
    ...
    <div style="margin-bottom: 14px;">
        ...
        <h4 style="margin: 6px 0 2px 0; font-weight: 700;">3. Simulate Adding Skills & Experience</h4>
    ...
    with sim_controls_col:
        # Default missing skills for this role
