...
def render_report_view(components: dict, ats_results: dict):
    """
    Renders the PDF Report generation tab.
    """
    ...
    st.markdown('<h4 style="margin-top:0; font-weight:700;">Evaluation Summary Preview</h4>', unsafe_allow_html=True)
    ...
    if st.button("🚀 Compile & Download Evaluation PDF", type="primary", use_container_width=True):
