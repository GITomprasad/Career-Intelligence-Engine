...
def render_report_view(components: dict, ats_results: dict):
    """
    Renders the PDF Report generation tab with robust error handling and native containers.
    """
    try:
        ...
        <div style="margin-bottom: 16px;">
            <h3 style="margin: 0 0 4px 0; font-weight: 800; color: var(--text-primary);">📑 Export Comprehensive Career Report</h3>
        ...
        with st.container(border=True):
            st.markdown('<h4 style="margin-top:0; font-weight:800; color: var(--text-primary);">Evaluation Summary Preview</h4>', unsafe_allow_html=True)
